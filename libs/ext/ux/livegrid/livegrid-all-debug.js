    ...
    updateInfo : function(rowIndex, visibleRows, totalCount)
    {
        ...
        if(this.recordDisplay){			
            var msg = totalCount == 0 ?
                ...
                String.format(this.displayMsg, rowIndex+1,
                              rowIndex+visibleRows, totalCount);				  								  
            this.recordDisplay.setValue(msg);
			this.doLayout();
        }
    },
...
// ----------------------------------- Listeners -------------------------------
    ...
    {		
		...
		if(this.recordDisplay){			
			this.baseBar.add(this.recordDisplay);									
			//something = Ext.fly(this.el.dom).createChild({cls:'x-paging-info'});
            //this.getParent().displayEl = Ext.fly(this.el.dom).createChild({cls:'x-paging-info'});
        }		
